...
st.header("1️ Average Price per Category")
st.dataframe(avg_price)

st.header("2️ Average Rating per Category")
st.dataframe(avg_rating)

st.header("3️ Product Count per Category")
st.dataframe(product_count)

st.header("4️ Top 5 Reviewed Items per Category")
st.dataframe(top_reviewed)

st.header("5️ Stock Availability Percentage per Category")
